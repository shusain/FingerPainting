package com.shaunhusain.fingerPainting.view.optionPanels
{
	...
	public class PanelBase extends Sprite
	{
		...
		public var _panelBackgroundBmp:Bitmap;
		public var _titleBackgroundBmp:Bitmap;
		public var _closeButtonBmp:Bitmap;
		...
		public function PanelBase()
		{
			...
			if(!backgroundSprite)
			{
				_panelBackgroundBmp = br.getBitmapByName("panelBackground.png");
			...
			if(!titleBackground)
			{
				_titleBackgroundBmp = br.getBitmapByName("titleBackground.png")
			...
			if(!closeButton)
			{
				_closeButtonBmp = br.getBitmapByName("closeButton.png")
